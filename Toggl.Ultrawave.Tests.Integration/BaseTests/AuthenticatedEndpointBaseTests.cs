...
namespace Toggl.Ultrawave.Tests.Integration.BaseTests
{
    public abstract class AuthenticatedEndpointBaseTests<T> : EndpointTestBase
    {
        ...
        public async Task WorksWithPassword()
        {
            ...
            ValidApi = TogglApiWith(credentials, NoFeatures);
        ...
        public async Task WorksWithApiToken()
        {
            ...
            ValidApi = TogglApiWith(apiTokenCredentials, NoFeatures);
        ...
        public async Task FailsForNonExistingUser()
        {
            ...
            CallingEndpointWith(TogglApiWith(wrongCredentials, NoFeatures)).ShouldThrow<ApiException>();
        }
        ...
        public async Task FailsWithWrongPassword()
        {
            ...
            ValidApi = TogglApiWith(correctCredentials, NoFeatures);
        ...
        public async Task FailsWithWrongApiToken()
        {
            ...
            CallingEndpointWith(TogglApiWith(wrongApiTokenCredentials, NoFeatures)).ShouldThrow<ApiException>();
        }
        ...
        public async Task FailsWithoutCredentials()
        {
            ...
            CallingEndpointWith(TogglApiWith(Credentials.None, NoFeatures)).ShouldThrow<ApiException>();
        }
    }
}
